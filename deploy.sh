...
git init
echo '[source](https://github.com/ceife/ceife.run)' > README.md

#============================================
# github
#============================================
echo 'ceife.run' > CNAME
git add -A
git commit -m 'deploy :octocat:'

# https://<USERNAME>.exemplo.io é obrigatorio ser na branch master!
git push -f https://github.com/ceife/ceife.github.io.git master
...
git push -f https://gitlab.com/ceife/ceife.gitlab.io.git master
